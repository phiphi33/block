 ...
 */
 ...
 /**
  * For clip and block, i've :
  * remove Pin diameter (pin_diameter = 0)
  * spline_thickness (spline_thickness=0)
  */
...
module block(
    ...
    wall_thickness=(brand == "lego" ? 1.3 : 1.5);
   ...
   translate([0,0, 0]) // Comment to position at 0,0,0 instead of centered on X and Y.
        union() {
            difference() {
                union() {
                    /**
